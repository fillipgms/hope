...
export default function Loading() {
    return (
        <div className="w-full space-y-2 flex flex-col items-center justify-center py-5">
            ...
            >
                <div className="md:absolute w-[100px] rounded-full overflow-hidden h-[100px] aspect-square md:p-1 md:top-1/2 md:-translate-y-1/2 md:-translate-x-1/2 md:block shadow-lg">
